...
<table>
    ...
    <tr>
        <td>4.50 设置数据修正参数 0x43</td>
        <td>0x43</td>
        <td>{corrName: 修正参数名称，corrCategory: 修正类型（0：清除修正参数，1：设置修正参数，2查询修正参数），interval: 采集间隔(单位:0.1秒), corrValue: 修正数据}</td>
        <td>见原协议</td>
        <td>返回：result:修正参数名称 data:当前修正数据</td>
    </tr>
</table>
