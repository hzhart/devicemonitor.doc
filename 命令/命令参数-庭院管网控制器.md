...
的远程安检时间安检)"}，转下格</td>
        <td>{"closeValveWhenCheck":"安检时关闭阀门（0-关阀检测， 1-开阀检测）","remoteCheckTime":"远程安检时间（月、日、时、分，格式：01020304）","checkInterval":"检测间隔（天）","leakPressureDropThreshold":"泄漏压降阈值（百分比，1个小数点）"}</td>
