...
<table>
    ...
    <tr>
        <td>5.2、设置检测项 0x51</td>
        <td>0x51</td>
        <td>{"valve":1,"cover65":1,"cover100":1,"pressure":1,"liquidLevel":1,"waterUsage":1}</td>
        <td>消火栓设置检测项, 1: 检测 0: 不检测</td>
        <td>valve: 阀杆检测, cover60: 60口盖, cover100: 100口盖, pressure: 压力, liquidLevel: 液位, waterUsage: 用水总量 可选值: 1:检测 0:不检测</td>
    </tr>
    <tr>
        <td>5.3、设置压力报警值 0x52</td>
        <td>0x52</td>
        <td>{"pressureAlarmLowerLimit":xxx,"pressureAlarmUpperLimit":xxx}</td>
        <td>消防栓设置压力告警值</td>
        <td>pressureAlarmLowerLimit:压力报警下限值 pressureAlarmUpperLimit:压力报警上限值</td>
    </tr>
    <tr>
    ...
    <tr>
        <td>5.6、设置电子标签号 0x55</td>
        <td>0x55</td>
        <td>{"electronicTag": "xxx"}</td>
        <td>消防栓设置电子标签</td>
        <td>electronicTag: 电子标签号</td>
    </tr>
    <tr>
        <td>5.7、设置流量系数 0x56</td>
        <td>0x56</td>
